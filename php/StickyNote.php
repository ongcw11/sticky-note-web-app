...
<main class="content">
    ...
    <div class="filter-bar">
        ...
        ?>
        <a href="../php/add_note.php" class="add-note-btn" id="add-note-btn">add new note</a>
    </div>
    ...
    function renderNote($note, $filter, $isCompleted = false)
    {
        $statusBtn = $isCompleted
            ? "<img src='../icon/uncomplete-btn.png' alt='Uncomplete' style='width:25px;height:25px;cursor:pointer;'onclick=\"event.stopPropagation(); window.location.href='../php/update_status.php?id={$note['id']}&status=Pending&filter={$filter}'\"></button>"
            : "<img src='../icon/complete-btn.png' alt='Complete' style='width:25px;height:25px;cursor:pointer;'onclick=\"event.stopPropagation(); window.location.href='../php/update_status.php?id={$note['id']}&status=Completed&filter={$filter}'\">";
        ...
        <div class='note-wrapper'>
            <div class='note-card'>
                ...
                <div class='dropdown-menu'>
                    ...
                    <button title='Delete' onclick=\"if(confirm('Are you sure you want to delete this note?')) window.location.href='../php/delete_note.php?id={$note['id']}'\">Delete</button>
                </div>
            </div>
        </div>";
    }
    ...
    <div style="margin-top: 30px;text-align:center;">
        <a href="../php/completed_task.php" class="add-note-btn" style="margin-top:20px;">Check All Completed Tasks</a>
    </div>
</main>

<script>
    // Show success popup if note was deleted
