        ...
        if ($result->num_rows == 0) {
            ...
            while ($note = $result->fetch_assoc()) {
                ...
                <div class='note-wrapper'>
                    <div class='note-card'>
                        <img src='../icon/uncomplete-btn.png' alt='Uncomplete' style='width:25px;height:25px;cursor:pointer;' onclick=\"event.stopPropagation(); window.location.href='../php/update_status.php?id={$note['id']}&status=Pending'\">
